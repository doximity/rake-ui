...
## [0.1.3] 
* Escape rake task log content instead of rendering raw HTML
  [#58](https://github.com/doximity/rake-ui/pull/58)

## [0.1.2]
* Add nanosecond precision to rake task log IDs to prevent collisions between concurrent executions of the same task
  [#57](https://github.com/doximity/rake-ui/pull/57)

## [0.1.1]
* Sanitize user input in `RakeTask#build_rake_command` to prevent shell injection
  [#55](https://github.com/doximity/rake-ui/pull/55)
* Bump version
  [#56](https://github.com/doximity/rake-ui/pull/56)
